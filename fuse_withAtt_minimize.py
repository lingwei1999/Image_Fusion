...
if __name__ == '__main__':
    ...
    f = Fuse('./cache/minimize_withAtt/best.pth')
    ...
    f('./data/test/ir', './data/test/vi', 'results/minimize_withAtt')

    model = 'minimize_withAtt'
    f('../datasets/TNO/Nato_sequence/thermal', '../datasets/TNO/Nato_sequence/visual', f'results/TNO/Nato/{model}')
    f('../datasets/TNO//Duine_sequence/thermal', '../datasets/TNO/Duine_sequence/visual', f'results/TNO/Duine/{model}')
    f('../datasets/TNO/Tree_sequence/thermal', '../datasets/TNO/Tree_sequence/visual', f'results/TNO/Tree/{model}')
